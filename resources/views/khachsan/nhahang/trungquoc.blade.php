...
@section('title',' Nhà hàng trung quốc')
@section('content')
<div id="services-section" class="pt-80 pt-xs-60">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sx-12">
                <div class="single-sidebar-widget">
                    <div class="special-links">
                        <ul>
                            <li><a href="#"> Nhà hàng trung quốc</a></li>
                            <li><a href="#"> Nhà hàng nhật bản</a></li>
                            <li><a href="#"> Nhà hàng italia</a></li>
                            <li><a href="#"> Nhà hàng Pháp</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
                <div class="full-pic">
                    <figure> <img src="{{asset('html/assets/images/banner/nhahang_trungquoc.jpg')}}" alt=""> </figure>
                </div>
                <div class="text-box mt-40">
                    <div class="box-title mb-20">
                        <h2>Nhà Hàng Trung quốc</h2>
                    </div>
                    <div class="text-content">
                        <p> không gian cổ điển .  </p>
                                    ...
                                    <div class="card-header" role="tab" id="headingOne">
                                        <h5 class="mb-0 panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                Duis aute irure dolor in reprehenderit <i class="fa fa-plus collape-plus"></i>
                                            </a>
                                        </h5>
                                    </div>
