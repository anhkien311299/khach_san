...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="{{route('phong-list')}}" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini">QLKS</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">Quản lý Khách sạn</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                ...
                <span>
                    <form action="{{route('nhanvien-logout')}}">
                        <table>
                            <tr>
                                <td style="color: white; font-size: 20px"><?php echo "Xin chào, ".$_SESSION['tenNhanVien']?></td>
                                <td>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active">
                    <a href="{{route('nhanvien-list')}}">
                        <i class="fa fa-dashboard"></i> <span>Quản lý Nhân viên</span>
                    </a>
                </li>
                <li class="active">
                    <a href="{{route('khachhang-list')}}">
                        <i class="fa fa-dashboard"></i> <span>Quản lý Khách hàng</span>
                    </a
                    >
                </li>
                <li class="active">
                    <a href="{{route('phong-list')}}">
                        <i class="fa fa-dashboard"></i> <span>Quản lý Phòng</span>
                    </a>
                </li>
                <li class="active">
                    <a href="{{route('loaiphong-list')}}">
                        <i class="fa fa-dashboard"></i> <span>Quản lý Loại phòng</span>
                    </a>
                </li>
                <li class="active">
